...
class App extends React.Component {
  ...
  _getGroups = async () => {
    try {
      ...
      if (Array.isArray(groups)) {
        ...
        this.setState({ groups, activeGroup }, () =>
          this._getGroupDemographics(activeGroup),
        )
      } else {
        this._handleError()
      }
  ...
  _handleError() {
    this.setState({
      errorMsg: 'Error retrieving requested demographic statistics.',
    })
  }
    ...
    return (
      <div className='app'>
        ...
        {errorMsg ? (
          ...
          <TabMenu tabs={this._generateTabs()} />
        )}
      </div>
    )
  }
